...
%%% CONSTANTS
%\newcommand{toronto}{Toronto, ON, Canada}
\def \toronto {Toronto, ON, Canada}
\def \vancouver {Vancouver, BC, Canada}
\def \winnipeg { Winnipeg, MB, Canada}
%\def\@winnipeg{Winnipeg, MB, Canada}
